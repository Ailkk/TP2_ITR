...
/* Alarm alarmForNavigation identifier */
#define alarmForNavigation_id 2
CONST(AlarmType, AUTOMATIC) alarmForNavigation = alarmForNavigation_id;
...
/*-----------------------------------------------------------------------------
 * Alarm alarmForNavigation descriptor
 *
...
CONST(tpl_task_activation_action, OS_CONST) alarmForNavigation_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  Navigation_id
...
CONST(tpl_alarm_static, OS_CONST) alarmForNavigation_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , alarmForNavigation_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarmForNavigation_action
};
...
VAR(tpl_time_obj, OS_VAR) alarmForNavigation_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarmForNavigation_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  200,
    /* date                         */  200,
